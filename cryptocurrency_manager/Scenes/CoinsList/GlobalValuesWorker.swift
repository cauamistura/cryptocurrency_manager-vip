...
class GlobalValuesWorker {
    ...
    func doFeachGlobalValues(completion: @escaping ((Result<GlobalModel?, CryptoCurrenciesError>) -> Void))  {
        dataProvider?.fetchGlobalValues()
        self.completion = completion
    }
}

extension GlobalValuesWorker: GlobalValuesDataProviserDelegate {
